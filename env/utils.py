"""
AmbuBrain - Data models and utility functions for the ambulance routing environment.
"""
...
def create_traffic_conditions(patient_zone: str) -> Tuple[List[TrafficCondition], str]:
